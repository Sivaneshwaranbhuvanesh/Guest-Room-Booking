...
const RoomManager = () => {
  ...
  const formRef = useRef(null); // Add this reference
  ...
  return (
    <div>
      ...
      <div className='room-manager'>
        <h1>Create Room</h1>
        <form ref={formRef} onSubmit={editIndex === -1 ? addRoom : updateRoom} className='room-manager-container'>
            ...
            <input className='room-manager-containers' placeholder='Enter Floor Size in Square Feet' type="text" name="name" value={floorsize} onChange={(e) => setFloorSize(e.target.value)} />
