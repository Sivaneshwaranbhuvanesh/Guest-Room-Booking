...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    axios.post('http://localhost:3001/register', { mobileNumber, email, password, userType })
      .then(result => {
        console.log(result)
  ...
  return (
    <div className='signup-container'>
      ...
      <form onSubmit={handleSubmit} className='form_containers'>
        ...
        <input type="text" placeholder="Enter your Mobile Number" required onChange={(e) => setMobileNumber(e.target.value)} />
        <label>E-mail:</label>
