...
app.put('/update/:id', upload.single('file'), (req, res) => {
  const { name, minBookingPeriod, maxBookingPeriod, rentPerDay,floorsize, description, numberofbed } = req.body;
  const updateData = { name, minBookingPeriod, maxBookingPeriod, rentPerDay,floorsize,description,numberofbed };
